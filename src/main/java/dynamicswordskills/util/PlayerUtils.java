...
public class PlayerUtils
{
	...
	public static boolean isBlocking(EntityPlayer player) {
		...
		/*
		 * if (player.isBlocking()) { return true; } else if
		 * (DynamicSwordSkills.isBG2Enabled) { return ((IBattlePlayer)
		 * player).isBattlemode() && ((IBattlePlayer) player).isBlockingWithShield(); }
		 * 
		 * return false;
		 */
	}
